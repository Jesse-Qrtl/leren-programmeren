...
print(f'- {str_amount_fraction(amount_pepper)} {str_units(amount_pepper,UNIT_PEPPER)} {TXT_PEPPER}')
print(f'- {str_amount_fraction(amount_oil)} {str_units(amount_oil,UNIT_OIL)} {TXT_OIL}')
